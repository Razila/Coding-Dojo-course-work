...
#prints numbers from 1 to 9, incrementing by 1 (1,2,3,4....9)

#2
for t in range(1, 10, 3):
    print(t)

#prints numbers from 1 to 9, incrementing by 3 (1, 4, 7)
...
#prints from 20 backward to 2 incrementing by 3 (20, 17, 14, 11, 8, 5, 2)
...
#prints "0,7,1,13,2,8,3,42,The answer to life, the universe, and everything."
